...
The DCF data dictionary is a baseline dictionary, it allows users to create
their own dictionaries by serving as a start point for new dictionaries. The
flexibility of the DCF dictionary makes the process of creating a new dictionary
more efficient and easy. DCF dictionary is used for
[CCLE](https://portals.broadinstitute.org/ccle),
[CPTAC](https://proteomics.cancer.gov/programs/cptac) and Canine datasets.

The DCF data dictionary provides the first level of validation for all data
stored in it. Written in YAML, JSON schemas define all the individual entities
...
The Data Model covers all of the nodes within the dictionary as well as the relationships between
...
We welcome all comments, feature requests, and pull requests using GitHub
issues or the [Gen3 community](https://forums.gen3.org).
